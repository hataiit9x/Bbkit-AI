...
echo "  source ~/.bashrc"
echo "  bb doctor"
echo "  bb engage '<program-policy-url>' --slug my-program   # H1/Intigriti/HackenProof/…"
echo "  # or: bb scope new my-program && edit engagements/.../scope.md"
echo "  bb ai sync   # Claude/Codex/Factory; set BB_EXTRA_SKILL_ROOTS for more agents"
